...
const snackFoods:Food[]=[
 snackFood('banh-trung-nuong','Bánh trứng nướng','Món ngọt',10,0,'snack-0','100% 47%'),
 snackFood('chuoi','Chuối','Trái cây',10,0,'snack-vietnam-5','100% 98.5%'),
 snackFood('bap-luoc','Bắp luộc','Ăn nhẹ',12,0,'snack-vietnam-1','0% 49%'),
 snackFood('banh-flan','Bánh flan','Món ngọt',15,0,'snack-0','33.3333% 47%'),
 snackFood('banh-tieu','Bánh tiêu','Món ngọt',15,0,'snack-vietnam-2','0% 94%'),
 snackFood('bap-nuong-mo-hanh','Bắp nướng mỡ hành','Món mặn',15,0,'snack-vietnam-1','100% 0%'),
 snackFood('dau-nanh-rang','Đậu nành rang','Ăn nhẹ',15,0,'snack-vietnam-4','100% 100%'),
 snackFood('dau-phong-rang','Đậu phộng rang','Ăn nhẹ',15,0,'snack-vietnam-4','66.6667% 50%'),
 snackFood('hat-huong-duong','Hạt hướng dương','Ăn nhẹ',15,0,'snack-vietnam-4','100% 50%'),
 snackFood('kem-chuoi','Kem chuối','Món ngọt',15,0,'snack-vietnam-4','0% 50%'),
 snackFood('tao-pho','Tào phớ','Món ngọt',15,0,'snack-vietnam-4','0% 0%'),
 snackFood('banh-bo-hap','Bánh bò hấp','Món ngọt',20,1,'snack-vietnam-2','33.3333% 94%'),
 snackFood('banh-cam','Bánh cam','Món ngọt',20,1,'snack-vietnam-2','100% 46%'),
 snackFood('banh-chuoi-hap','Bánh chuối hấp','Món ngọt',20,1,'snack-vietnam-3','33.3333% 0%'),
 snackFood('banh-da-lon','Bánh da lợn','Món ngọt',20,1,'snack-vietnam-2','100% 94%'),
 snackFood('banh-duc-la-dua','Bánh đúc lá dứa','Món ngọt',20,1,'snack-vietnam-4','33.3333% 50%'),
 snackFood('banh-gio','Bánh giò','Món mặn',20,1,'snack-vietnam-0','0% 94%'),
 snackFood('bap-xao-tom-kho','Bắp xào tôm khô','Món mặn',20,1,'snack-vietnam-1','66.6667% 0%'),
 snackFood('cam','Cam','Trái cây',20,1,'snack-vietnam-5','100% 49%'),
 snackFood('che-dau-den','Chè đậu đen','Món ngọt',20,1,'snack-0','66.6667% 47%'),
 snackFood('che-dau-do','Chè đậu đỏ','Món ngọt',20,1,'snack-vietnam-3','0% 94%'),
 snackFood('che-dau-xanh','Chè đậu xanh','Món ngọt',20,1,'snack-vietnam-3','100% 46%'),
 snackFood('chuoi-chien','Chuối chiên','Món ngọt',20,1,'snack-vietnam-2','66.6667% 46%'),
 snackFood('coc','Cóc','Trái cây',20,1,'snack-vietnam-5','0% 49%'),
 snackFood('dua-hau','Dưa hấu','Trái cây',20,1,'snack-vietnam-5','0% 0%'),
 snackFood('du-du','Đu đủ','Trái cây',20,1,'snack-vietnam-5','66.6667% 98.5%'),
 snackFood('hat-bi-rang','Hạt bí rang','Ăn nhẹ',20,1,'snack-vietnam-4','0% 100%'),
 snackFood('khoai-lang-nuong','Khoai lang nướng','Ăn nhẹ',20,1,'snack-vietnam-1','33.3333% 49%'),
 snackFood('oi','Ổi','Trái cây',20,1,'snack-vietnam-5','66.6667% 0%'),
 snackFood('quyt','Quýt','Trái cây',20,1,'snack-vietnam-5','0% 98.5%'),
 snackFood('rong-bien-say','Rong biển sấy','Ăn nhẹ',20,1,'snack-vietnam-4','66.6667% 100%'),
 snackFood('thanh-long','Thanh long','Trái cây',20,1,'snack-vietnam-5','33.3333% 98.5%'),
 snackFood('thom-dua','Thơm (dứa)','Trái cây',20,1,'snack-vietnam-5','33.3333% 49%'),
 snackFood('banh-bo-nuong','Bánh bò nướng','Món ngọt',25,1,'snack-vietnam-2','66.6667% 94%'),
 snackFood('banh-duc-nong','Bánh đúc nóng','Món mặn',25,1,'snack-vietnam-0','33.3333% 94%'),
 snackFood('banh-khoai-mi-nuong','Bánh khoai mì nướng','Món ngọt',25,1,'snack-vietnam-3','0% 0%'),
 snackFood('banh-ran-man','Bánh rán mặn','Món mặn',25,1,'snack-vietnam-0','100% 46%'),
 snackFood('banh-su-kem','Bánh su kem','Món ngọt',25,1,'snack-vietnam-3','66.6667% 0%'),
 snackFood('banh-trang-bo','Bánh tráng bơ','Món mặn',25,1,'snack-vietnam-0','66.6667% 0%'),
 snackFood('banh-trang-nuong','Bánh tráng nướng','Món mặn',25,1,'snack-vietnam-0','0% 0%'),
 snackFood('banh-trang-tron','Bánh tráng trộn','Món mặn',25,1,'snack-0','0% 0%'),
 snackFood('che-ba-mau','Chè ba màu','Món ngọt',25,1,'snack-vietnam-3','66.6667% 46%'),
 snackFood('che-buoi','Chè bưởi','Món ngọt',25,1,'snack-vietnam-3','0% 46%'),
 snackFood('che-suong-sa-hat-luu','Chè sương sa hạt lựu','Món ngọt',25,1,'snack-vietnam-3','100% 94%'),
 snackFood('che-troi-nuoc','Chè trôi nước','Món ngọt',25,1,'snack-vietnam-3','33.3333% 94%'),
 snackFood('chom-chom','Chôm chôm','Trái cây',25,1,'snack-vietnam-6','100% 0%'),
 snackFood('hat-de-rang','Hạt dẻ rang','Ăn nhẹ',25,1,'snack-vietnam-4','33.3333% 100%'),
 snackFood('khoai-lang-ken','Khoai lang kén','Món mặn',25,1,'snack-vietnam-1','66.6667% 49%'),
 snackFood('mang-cau-ta','Mãng cầu ta (na)','Trái cây',25,1,'snack-vietnam-6','66.6667% 46%'),
 snackFood('nhan','Nhãn','Trái cây',25,1,'snack-vietnam-6','0% 46%'),
 snackFood('roi-man-mien-nam','Roi (mận miền Nam)','Trái cây',25,1,'snack-vietnam-6','100% 94%'),
 snackFood('sapoche','Sapoche','Trái cây',25,1,'snack-vietnam-6','100% 46%'),
 snackFood('sua-chua-mit','Sữa chua mít','Món ngọt',25,1,'snack-vietnam-4','33.3333% 0%'),
 snackFood('sua-chua-nep-cam','Sữa chua nếp cẩm','Ăn nhẹ',25,1,'snack-0','66.6667% 93%'),
 snackFood('tao','Táo','Trái cây',25,1,'snack-vietnam-6','66.6667% 94%'),
 snackFood('vu-sua','Vú sữa','Trái cây',25,1,'snack-vietnam-6','0% 94%'),
 snackFood('xoai-chin','Xoài chín','Trái cây',25,1,'snack-vietnam-5','100% 0%'),
 snackFood('xuc-xich-nuong','Xúc xích nướng','Món mặn',25,1,'snack-vietnam-1','0% 98.5%'),
 snackFood('banh-beo','Bánh bèo','Món mặn',30,2,'snack-vietnam-0','66.6667% 94%'),
 snackFood('banh-bot-loc','Bánh bột lọc','Món mặn',30,2,'snack-vietnam-0','100% 94%'),
 snackFood('banh-goi','Bánh gối','Món mặn',30,2,'snack-vietnam-0','66.6667% 46%'),
 snackFood('banh-nam','Bánh nậm','Món mặn',30,2,'snack-vietnam-1','0% 0%'),
 snackFood('banh-trang-cuon','Bánh tráng cuốn','Món mặn',30,2,'snack-vietnam-0','33.3333% 0%'),
 snackFood('bot-chien','Bột chiên','Món mặn',30,2,'snack-vietnam-0','100% 0%'),
 snackFood('buoi','Bưởi','Trái cây',30,2,'snack-vietnam-5','66.6667% 49%'),
 snackFood('ca-vien-chien','Cá viên chiên','Món mặn',30,2,'snack-0','33.3333% 0%'),
 snackFood('che-khoai-deo','Chè khoai dẻo','Món ngọt',30,2,'snack-vietnam-3','66.6667% 94%'),
 snackFood('che-thai','Chè Thái','Món ngọt',30,2,'snack-vietnam-3','33.3333% 46%'),
 snackFood('dua-luoi','Dưa lưới','Trái cây',30,2,'snack-vietnam-5','33.3333% 0%'),
 snackFood('kem-xoi','Kem xôi','Món ngọt',30,2,'snack-vietnam-4','100% 0%'),
 snackFood('khoai-tay-chien','Khoai tây chiên','Món mặn',30,2,'snack-0','100% 0%'),
 snackFood('kho-ga-la-chanh','Khô gà lá chanh','Món mặn',30,2,'snack-vietnam-2','100% 0%'),
 snackFood('mit','Mít','Trái cây',30,2,'snack-vietnam-6','0% 0%'),
 snackFood('pho-mai-que','Phô mai que','Món mặn',30,2,'snack-vietnam-1','100% 49%'),
 snackFood('trung-cut-lon-xao-me','Trứng cút lộn xào me','Món mặn',30,2,'snack-vietnam-1','100% 98.5%'),
 snackFood('vai','Vải','Trái cây',30,2,'snack-vietnam-6','33.3333% 46%'),
 snackFood('ha-cao-tom','Há cảo tôm','Món mặn',35,2,'snack-vietnam-0','0% 46%'),
 snackFood('kem-dua','Kem dừa','Món ngọt',35,2,'snack-vietnam-4','66.6667% 0%'),
 snackFood('mang-cut','Măng cụt','Trái cây',35,2,'snack-vietnam-6','66.6667% 0%'),
 snackFood('nem-chua-ran','Nem chua rán','Món mặn',35,2,'snack-0','66.6667% 0%'),
 snackFood('nho','Nho','Trái cây',35,2,'snack-vietnam-6','33.3333% 94%'),
 snackFood('sui-cao-chien','Sủi cảo chiên','Món mặn',35,2,'snack-vietnam-0','33.3333% 46%'),
 snackFood('trai-cay-dam','Trái cây dầm','Ăn nhẹ',35,2,'snack-0','33.3333% 93%'),
 snackFood('banh-khot','Bánh khọt','Món mặn',40,3,'snack-vietnam-1','33.3333% 0%'),
 snackFood('bong-lan-trung-muoi','Bông lan trứng muối','Món ngọt',40,3,'snack-vietnam-3','100% 0%'),
 snackFood('chan-ga-nuong','Chân gà nướng','Món mặn',40,3,'snack-vietnam-1','66.6667% 98.5%'),
 snackFood('muc-rim-me','Mực rim me','Món mặn',40,3,'snack-vietnam-2','33.3333% 46%'),
 snackFood('oc-luoc','Ốc luộc','Món mặn',40,3,'snack-vietnam-2','0% 0%'),
 snackFood('chan-ga-sa-tac','Chân gà sả tắc','Món mặn',45,3,'snack-vietnam-1','33.3333% 98.5%'),
 snackFood('kho-bo-soi','Khô bò sợi','Món mặn',45,3,'snack-vietnam-2','0% 46%'),
 snackFood('hat-dieu-rang','Hạt điều rang','Ăn nhẹ',50,4,'snack-0','100% 93%'),
 snackFood('oc-xao-dua','Ốc xào dừa','Món mặn',50,4,'snack-vietnam-2','33.3333% 0%'),
 snackFood('so-diep-nuong-mo-hanh','Sò điệp nướng mỡ hành','Món mặn',50,4,'snack-vietnam-2','66.6667% 0%'),
 snackFood('takoyaki','Takoyaki','Món mặn',50,4,'snack-0','0% 47%'),
 snackFood('sau-rieng','Sầu riêng','Trái cây',65,4,'snack-vietnam-6','33.3333% 0%'),
 snackFood('banh-cheesecake','Bánh cheesecake','Món ngọt',80,4,'snack-0','0% 93%'),
];
...
export default function Home(){
 ...
 const changeRollType=(next:RollType)=>{setRollType(next);setBudget(next==='main'?'50':next==='drinks'?'25':'20');setCatalogCategory('all');if(next!=='main')setVeg(false);setResult(null)};
